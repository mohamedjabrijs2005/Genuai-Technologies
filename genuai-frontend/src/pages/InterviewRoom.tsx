    ...
    <div style={{minHeight:"100vh",background:"#F8FAFC",color:"#1E293B",padding:"24px",fontFamily:"-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif"}}>
      ...
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"28px"}}>
        <div style={{display:"flex",alignItems:"center",gap:"12px"}}>
          <img src="/logo.png" alt="GenuAI" style={{width:"44px",height:"44px",objectFit:"contain",filter:"drop-shadow(0 2px 8px rgba(212,175,55,0.5))"}}/>
          <div>
        ...
        <div style={{maxWidth:"600px",margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:"28px"}}>
            <div style={{display:"inline-flex",alignItems:"center",gap:"10px",marginBottom:"14px"}}>
              <img src="/logo.png" alt="GenuAI" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 4px 16px rgba(212,175,55,0.5))"}}/>
      ...
      {phase==="waiting"&&(
        <div style={{maxWidth:"500px",margin:"0 auto"}}>
          <div style={{background:"#fff",border:"1.5px solid #E2E8F0",borderRadius:"20px",padding:"36px 30px",textAlign:"center",boxShadow:"0 4px 24px rgba(0,0,0,0.09)"}}>
            <img src="/logo.png" alt="GenuAI" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 4px 12px rgba(212,175,55,0.5))",marginBottom:"16px"}}/>
            ...
            <div style={{position:"relative",display:"inline-block",marginBottom:"24px"}}>
              ...
              <div style={{position:"absolute",top:"50%",left:"50%",transform:"translate(-50%,-50%)",background:"#fff",borderRadius:"10px",padding:"5px",boxShadow:"0 2px 8px rgba(0,0,0,0.15)"}}>
                <img src="/logo.png" alt="G" style={{width:"36px",height:"36px",objectFit:"contain",display:"block"}}/>
              </div>
            </div>
            ...
            <div>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"16px",marginBottom:"16px"}}>
                ...
                <div style={{background:"#F8FAFC",border:"1.5px solid #E2E8F0",borderRadius:"14px",display:"flex",alignItems:"center",justifyContent:"center",height:"280px",flexDirection:"column",gap:"12px"}}>
                  <img src="/logo.png" alt="GenuAI" style={{width:"52px",height:"52px",objectFit:"contain",filter:"drop-shadow(0 2px 8px rgba(212,175,55,0.4))"}}/>
