                  ...
                  <div key={c.id} style={{ background: "#FFFFFF", border: "1px solid " + (i === 0 ? "#FFD700" : i === 1 ? "#C0C0C0" : i === 2 ? "#CD7F32" : "#E2E8F0"), borderRadius: "12px", padding: "16px 20px", marginBottom: "12px", display: "flex", alignItems: "center", gap: "16px", flexWrap: "wrap" }}>
                    ...
                    {overriding === c.id ? (
                      <div style={{ display: "flex", gap: "4px" }}>
                        ...
                        <button onClick={() => setOverriding(null)} style={{ ...btn, background: "#E2E8F0", color: "#1E293B", fontSize: "11px", padding: "5px 8px" }}>X</button>
                      </div>
                    ) : (
                        ...
                        <td style={{ padding: "10px 12px" }}>
                          {overriding === c.id ? (
                            <div style={{ display: "flex", gap: "3px" }}>
                              ...
                              <button onClick={() => setOverriding(null)} style={{ ...btn, background: "#E2E8F0", color: "#1E293B", fontSize: "10px", padding: "3px 6px" }}>X</button>
                            </div>
                          ) : (
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                ...
                <div>
                  {compareList.length === 0 ? (
                    <div style={{ textAlign: "center", padding: "60px", background: "#FFFFFF", borderRadius: "12px", border: "1px dashed #E2E8F0", color: "#64748B" }}>
                      <div style={{ fontSize: "40px", marginBottom: "12px" }}>📊</div>
