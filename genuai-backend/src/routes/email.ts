...
<div style="max-width:600px;margin:40px auto;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 8px 30px rgba(0,0,0,0.1);">
  ...
  <div style="background:#F8FAFC;padding:24px 32px;text-align:center;border-top:1px solid #E2E8F0;">
    <div style="margin-bottom:8px;">
      <span style="display:inline-block;width:32px;height:32px;background:linear-gradient(135deg,#667EEA,#764BA2);border-radius:8px;text-align:center;line-height:32px;font-weight:900;color:#fff;font-size:16px;vertical-align:middle;">G</span>
      <span style="color:#1E293B;font-weight:700;font-size:15px;vertical-align:middle;margin-left:8px;">GenuAI Technologies</span>
    </div>
...
router.post('/verdict', async (req, res) => {
  try {
    ...
    const htmlBody = isHired ? `<!DOCTYPE html>
